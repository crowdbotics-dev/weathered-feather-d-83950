...
## Project Structure
    ...
    ├── weathered_feather_d_83950  # Django project configurations
...
1. Clone this repo and `cd weathered_feather_d_83950`
...
2. Clone this repo and `cd weathered_feather_d_83950`
